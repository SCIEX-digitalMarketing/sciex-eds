...
`;
  ...
  const isValidEnrollmentCourseType = validEnrollmentCourseType.includes(courseType.toLowerCase()) || validEnrollmentCourseType.includes(trainingType.toLowerCase());
